...
def test_a_bridge(
    ...
    k3d.apply("tests/fixtures/bridge_mount_demo.yaml")
    k3d.wait(
    ...
    k3d.apply("tests/fixtures/a_gefyra_bridge_carrier2_demo.yaml")
    k3d.wait(
    ...
    k3d.wait(
        "pod/backend",
        "jsonpath=.status.containerStatuses[0].image=quay.io/gefyra/carrier2:latest",
        namespace="demo",
        timeout=60,
    )
    k3d.wait(
    ...
    k3d.kubectl(
        [
            ...
            "delete",
            "-f",
            "tests/fixtures/a_gefyra_bridge_carrier2.yaml",
        ],
        as_dict=False,
    )
    k3d.kubectl(
        ["-n", "gefyra", "delete", "-f", "tests/fixtures/bridge_mount_demo.yaml"],
        as_dict=False,
    )
    # k3d.wait(
    #     "pod/backend",
