...
If you are interested in more sophisticated use cases or want to develop modern Kubernetes-based architectures, check out the [use cases and demos](/en/usecases-and-demos/getting-started) or the [media](/en/information/media) section.